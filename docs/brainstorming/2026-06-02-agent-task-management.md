...
> **Raw research — superseded by [vision.md](../vision.md) and [ADR 019](../decisions/019-drop-task-model-filesystem-sessions.md).** The task model described here was removed. Kept for provenance; not current truth.
