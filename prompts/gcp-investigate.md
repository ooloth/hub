...
- `line` — raw JSON log entry with full context

## Investigation pattern

### 1. Parse the log line

Read the raw JSON `line` for the full log context: stack trace, request details, jsonPayload, or textPayload. Extract the most specific signal — an exception type, a function name, a message prefix.
